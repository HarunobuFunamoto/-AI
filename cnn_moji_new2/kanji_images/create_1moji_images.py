...
for font in font_list:
    for kanji in kanji_li: 
        moji_list= font_image(font, kanji, nb)
        ...
        for i , m in enumerate(moji_list):
            cv2.imwrite(kanji+'/'+kanji+'_'+str(i)+'_'+str(font)+'_noise.jpg' , m)
        

        moji_list2= font_image2(font, kanji, nb)
        ...
        for i , m in enumerate(moji_list2):
            cv2.imwrite(kanji+'/'+kanji+'_'+str(i)+'_'+str(font)+'_noise2.jpg' , m)
        

        moji_list3= font_image3(font, kanji, nb)
        ...
        for i , m in enumerate(moji_list3):
            cv2.imwrite(kanji+'/'+kanji+'_'+str(i)+'_'+str(font)+'.jpg' , m)
...
print(kanji+ '画像枚数',mojinum * len(font_list))  
