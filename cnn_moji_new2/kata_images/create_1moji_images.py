...
for font in font_list:
    for katakana in katakana_li: 
        moji_list= font_image(font, katakana, nb)
        moji_list = np.array(moji_list)
        

        if not os.path.exists(katakana) :
            os.makedirs(katakana)
        for i , m in enumerate(moji_list):
            cv2.imwrite(katakana+'/'+katakana+'_'+str(i)+'_'+str(font)+'_noise.jpg' , m)
        

        moji_list2= font_image2(font, katakana, nb)
        ...
        for i , m in enumerate(moji_list2):
            cv2.imwrite(katakana+'/'+katakana+'_'+str(i)+'_'+str(font)+'_noise2.jpg' , m)
        

        moji_list3= font_image3(font, katakana, nb)
        ...
        for i , m in enumerate(moji_list3):
            cv2.imwrite(katakana+'/'+katakana+'_'+str(i)+'_'+str(font)+'.jpg' , m)
...
print(katakana+ '画像枚数',mojinum * len(font_list))  
